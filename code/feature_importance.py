...
def load_data(df):
    ...
    X_train, X_test, y_train, y_test = train_test_split(full, y, test_size=0.3, random_state=42)
...
if __name__ == '__main__':
    ...
    for i in range(143):
        ...
        best_new_rmse = np.mean(new_rmses) # I think I should try this over but taking the mean of 10 instead of the best of ten... could be more representative
