...
# full = imp.transform(full_pre) #transforms all NaNs to mean in each column
...
X_train, X_test, y_train, y_test = train_test_split(df_num_X2, y, test_size=0.25, random_state=23)


rf = RandomForestRegressor(n_estimators=1000,oob_score=True, max_features=70, n_jobs=3, verbose=True, min_samples_leaf=5, max_depth=7)
